...
plugin = qiime2.plugin.Plugin(
    ...
    description=('Package to contextualize table of taxonomical frequency of samples to metabolic reconstruction (AGORA v1.0.3, AGORA v2.0.1 or AGREDA) and extract features based on score of active reactions or subsystems.'),
...
plugin.methods.register_function(
    ...
    parameter_descriptions={'selection': 'selection metabolic network among AGREDA, AGORAv103, AGORAv201',
                            'level': 'taxonomical level of interest: k (kingdom/domain), p (phylum), c (class), o (order), f (family), g (genus), s (species, default)',
...
# Register visualizer for the PCA
plugin.visualizers.register_function(
    function=plotPCA,
    inputs={
        'table': FeatureTable[Frequency]
...
# Register visualizer for the boxplot
plugin.visualizers.register_function(
