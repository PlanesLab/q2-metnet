...
qiime metnet plotPCA \
	...
	--o-visualization ./subs_pca.qzv
```

Additionally, a hierarchically-clustered heatmap can be generated by running the `plotClusteMap`function. In the following example, we are going to generate the heatmap of the reaction scores across samples.
...
qiime metnet plotClusteMap 
	...
	--m-sample-metadata-file ./test/meta.tsv \
	--m-sample-metadata-column Condition \
	--o-visualization ../subs_hclust.qzv
```
